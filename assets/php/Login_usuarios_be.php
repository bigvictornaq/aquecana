<?php
     ...
     if(isset($_POST['Correo']) && isset($_POST['Password'])){
          ...
          if(empty($correo)){
               header("location: ../index2.php?error=su correo es requerido");
          }else if(empty($password)){
               //corrige la palabra contrasena
               header("location: ../index2.php?error=su contraseña es requerida {$correo}");
          }else{
               ...
               if(mysqli_num_rows($validar_login) === 1){
                    //correo debe ser unico si no vale x===D
                    $row = mysqli_fetch_assoc($validar_login); // hay que obtener los datos 
                    ...
                    header("location: ../index2.php?error=Verifique sus datos");
               }
          }
